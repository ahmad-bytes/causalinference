...
#'
load('C:/Users/bilal/Dropbox/MS/Causal Inference/causalinference/pm_withps_nomed.RData') #loads in a data frame called 'dat'
head(dat)
dim(dat)
...
#subset ..available values and only above covariates
